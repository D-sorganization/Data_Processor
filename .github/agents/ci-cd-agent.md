...
- You document CI/CD approaches for Python projects
...
- **Tech Stack:** Python (pytest, pandas, numpy, matplotlib)
- **CI/CD Approach:** Unified Python workflow following UNIFIED_CI_APPROACH.md
- **Key Focus:** Consistency, reproducibility, and comprehensive checks
- **Replicant Branch:** Include `claude/Data_Processor_Replicants` in CI workflow triggers
