...
- You write for developers working with Python code

## Project knowledge
- **Repository Type:** Python Data Processing Application
- **Primary Language:** Python
- **Key Technologies:** Python, pytest, pandas, numpy, matplotlib, Git, GitHub Actions, CI/CD workflows
- **Special Branch:** This repository has a replicant branch `claude/Data_Processor_Replicants` that must NEVER be merged to main

**File Structure:**
- **Root Directory:**
  - `README.md` - Main project documentation
  - `docs/` - Additional documentation (BRANCHING_WORKFLOW_RULE.md, SAFE_STATE.md)
  - `python/` - Python source code and tests
    - `python/src/` - Source code
    - `python/tests/` - Test files
    - `python/data_processor/` - Main application code
  - `scripts/` - Utility scripts
  - `data/` - Data files
  - `output/` - Generated output files
  - `quality_check_script.py` - Quality check script
