...
def test_process_single_csv_file_basic(sample_csv):
    settings = {
...
def test_process_single_csv_file_with_filtering(sample_csv):
    settings = {
        "selected_signals": ["Signal1"],
...
def test_process_single_csv_file_with_resampling(sample_csv):
    settings = {
        "selected_signals": ["Signal1"],
        "filter_type": "None",
...
def test_process_single_csv_file_invalid_file():
    settings = {
        "selected_signals": ["Signal1"],
    }
